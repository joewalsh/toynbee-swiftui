enum Stop: Int, CaseIterable, Codable, Identifiable, Hashable {
    ...
    var param: String {
        return Stop.paramByStop[self] ?? ""
    }

    private static let paramByStop: [Stop: String] = [
    ...
    var name: String {
        return Stop.nameByStop[self] ?? ""
    }
    
    private static let nameByStop: [Stop: String] = [
        .thirteithStreetStation: "30th Street Station",
    ...
    private static let byName: [String: Stop] = [
        "30th Street Station": .thirteithStreetStation,
        "49th Street": .fortyNinthStreet,
        "9th Street Lansdale": .ninthStreetLansdale,
        "Airport Terminal A": .airportTerminalA,
        "Airport Terminal B": .airportTerminalB,
        "Airport Terminal C D": .airportTerminalCD,
        "Airport Terminal E F": .airportTerminalEF,
        "Allegheny": .allegheny,
        "Allen Lane": .allenLane,
        "Ambler": .ambler,
        "Angora": .angora,
        "Ardmore": .ardmore,
        "Ardsley": .ardsley,
        ...
        "Carpenter": .carpenter,
        "Chalfont": .chalfont,
        "Chelten Avenue": .cheltenAvenue,
        "Cheltenham": .cheltenham,
        "Chester": .chester,
        "Chestnut Hill East": .chestnutHillEast,
        "Chestnut Hill West": .chestnutHillWest,
        "Churchman's Crossing": .churchmansCrossing,
        "Claymont": .claymont,
        "Clifton-Aldan": .cliftonAldan,
        "Colmar": .colmar,
        "Conshohocken": .conshohocken,
        "Cornwells Heights": .cornwellsHeights,
        "Crestmont": .crestmont,
        "Croydon": .croydon,
        "Crum Lynne": .crumLynne,
        "Curtis Park": .curtisPark,
        "Cynwyd": .cynwyd,
        "Darby": .darby,
        "Daylesford": .daylesford,
        "Delaware Valley College": .delawareValleyCollege,
        "Devon": .devon,
        "Downingtown": .downingtown,
        "Doylestown": .doylestown,
        "East Falls": .eastFalls,
        "Eastwick": .eastwick,
        "Eddington": .eddington,
        "Eddystone": .eddystone,
        "Elkins Park": .elkinsPark,
        "Elwyn": .elwyn,
        "Exton": .exton,
        "Fern Rock T C": .fernRockTC,
        "Fernwood-Yeadon": .fernwoodYeadon,
        "Folcroft": .folcroft,
        "Forest Hills": .forestHills,
        "Fort Washington": .fortWashington,
        "Fortuna": .fortuna,
        "Fox Chase": .foxChase,
        "Germantown": .germantown,
        "Gladstone": .gladstone,
        ...
        "Glenside": .glenside,
        "Gravers": .gravers,
        "Gwynedd Valley": .gwyneddValley,
        "Hatboro": .hatboro,
        "Haverford": .haverford,
        "Highland": .highland,
        "Highland Avenue": .highlandAvenue,
        "Holmesburg Jct": .holmesburgJct,
        "Ivy Ridge": .ivyRidge,
        "Jefferson Station": .jeffersonStation,
        "Jenkintown Wyncote": .jenkintownWyncote,
        "Langhorne": .langhorne,
        "Lansdale": .lansdale,
        "Lansdowne": .lansdowne,
        "Lawndale": .lawndale,
        "Levittown-Tullytown": .levittownTullytown,
        "Link Belt": .linkBelt,
        "Main Street": .mainStreet,
        "Malvern": .malvern,
        "Manayunk": .manayunk,
        "Marcus Hook": .marcusHook,
        "Meadowbrook": .meadowbrook,
        "Media": .media,
        "Melrose Park": .melrosePark,
        "Merion": .merion,
        "Miquon": .miquon,
        "Morton-Rutledge": .mortonRutledge,
        "Mount Airy": .mountAiry,
        "Moylan-Rose Valley": .moylanRoseValley,
        "Narberth": .narberth,
        "Neshaminy": .neshaminy,
        "New Britain": .newBritain,
        "Newark": .newark,
        "Noble": .noble,
        "Norristown Elm Street": .norristownElmStreet,
        "Norristown T.C.": .norristownTC,
        "North Broad": .northBroad,
        "North Hills": .northHills,
        "North Philadelphia": .northPhiladelphia,
        "North Philadelphia Amtrak": .northPhiladelphiaAmtrak,
        ...
        "Philmont": .philmont,
        "Primos": .primos,
        "Prospect Park - Moore": .prospectParkMoore,
        "Queen Lane": .queenLane,
        "Radnor": .radnor,
        "Ridley Park": .ridleyPark,
        "Rosemont": .rosemont,
        "Roslyn": .roslyn,
        "Rydal": .rydal,
        "Ryers": .ryers,
        "Secane": .secane,
        "Sedgwick": .sedgwick,
        "Sharon Hill": .sharonHill,
        "Somerton": .somerton,
        "Spring Mill": .springMill,
        "St. Davids": .stDavids,
        "St. Martins": .stMartins,
        "Stenton": .stenton,
        "Strafford": .strafford,
        "Suburban Station": .suburbanStation,
        "Swarthmore": .swarthmore,
        "Tacony": .tacony,
        ...
        "Wallingford": .wallingford,
        "Warminster": .warminster,
        "Washington Lane": .washingtonLane,
        "Wayne": .wayne,
        "Wayne Junction": .wayneJunction,
        "West Trenton": .westTrenton,
        "Whitford": .whitford,
        "Willow Grove": .willowGrove,
        "Wilmington": .wilmington,
        "Wissahickon": .wissahickon,
        "Wister": .wister,
        "Woodbourne": .woodbourne,
        "Wyndmoor": .wyndmoor,
        "Wynnefield Avenue": .wynnefieldAvenue,
        "Wynnewood": .wynnewood,
        "Yardley": .yardley,
    ]
    
    static func with(name: String) -> Stop? {
        return byName[name]
    }
}
